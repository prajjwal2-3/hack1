      ...
      <section className="flex justify-between   px-20">
        <section className="logo-of-myorg flex gap-10">
          ...
          <section className="flex flex-col">
            <p className="text-5xl text-slate-800 font-bold">{org.name}</p>
        ...
        <section className="flex  flex-col">
          <p className="text-xl font-semibold text-slate-800">
            Email address: <span className="text-slate-600">{org.email}</span>
          </p>
          <p className="text-xl font-semibold text-slate-800">
            Phone number: <span className="text-slate-600">{org.phone}</span>
          </p>
        </section>
